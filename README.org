...
#+begin_src emacs-lisp
  ...
  (use-package torus
    ...
    :bind (("<s-insert>" . torus-add-here)
           ...
           ("<S-home>" . torus-previous-torus)
           ("<S-end>" . torus-next-torus)
           ...
           ("<S-next>" . torus-older)
           ("C-^" . torus-alternate)
	   ("s-^" . torus-alternate-in-same-torus-other-circle)
...
Enter the prefix key, then :
  ...
  - =<C-left>= : go to previous circle

  - =<C-right>= : go to next circle

  - =<S-left>= : go to previous torus

  - =<S-right>= : go to next torus
...
Enter the prefix key, then :
  ...
  - =<tab>= : newer location in history

  - =<backtab>= : older location in history

  - =<up>= : move location backward

  - =<down>= : move location forward

  - =<C-up>= : move circle backward

  - =<C-down>= : move circle forward

  - =<S-up>= : move torus backward

  - =<S-down>= : move torus forward
...
Enter the prefix key, then :
  ...
  - =<prior>= : rotate circle to the left

  - =<next>= : rotate circle to the right

  - =<C-prior>= : rotate torus to the left

  - =<C-next>= : rotate torus to the right

  - =<S-prior>= : rotate wheel to the left

  - =<S-next>= : rotate wheel to the right

  - =<home>= : roll circle to the beginning

  - =<end>= : roll circle to the end

  - =<C-home>= : roll torus to the beginning

  - =<C-end>= : roll torus to the end

  - =<S-home>= : roll wheel to the beginning

  - =<S-end>= : roll wheel to the end
